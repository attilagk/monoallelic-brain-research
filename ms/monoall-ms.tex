...
Genomic imprinting is mainly characteristic to humans and other placental
organisms and, in line with this, some well-known physiological functions of imprinted genes include
embryonic and placental development, body growth, suckling, and maternal
behavior.  Imprinted gene syndromes, like Prader-Willi, Angelman,..., support
involvement involvement not only in pre and postnatal growth but also in
...
paternal chromosome but not on both.  Each ICR controls typically a cluster of
imprinted genes within a few hundred kilobases such that the alleles are
expressed in a parent-of-origin specific level.  We refer to in this work as
\emph{parental bias} to emphasize that the relative expression level of one
allele of some gene, at least when averaged over multiple cells in a tissue,
may range anywhere between 0 and 1.  Imprinted genes, near 0 or 1, are biased
or even monoallelic expressed, whereas most non-imprinted genes are near
\(1/2\), that is, essentially unbiased.

Why natural selection favors parental bias for imprinted genes remains debated
but the most mature of all theories, kinship or conflict theory, provides a
flexible framework for interpreting past studies on imprinted genes and
formulating hypotheses and predictions regarding their detailed regulation and
physiological function.  The theory suggests that imprinted genes contribute
to inter-individual interactions in a highly dose-dependent fashion, and so
explains bias with the conflicting interests of paternal and maternal genes,
which arise from sexual asymmetries in those interactions.  A well-known asymmetry
is the disproportionate importance of mothers in nurturing children in
Placentalia.  Kinship theory thus explains why overexpression disorders of
paternally and maternally biased genes abnormally promote and inhibit,
respectively, children's growth.

Since different inter-individual interactions take place in various
developmental stages and are mediated by various organs, the theory explains
the non-uniform pattern of ``imprintedness'' and parental bias over various
ages and tissue types seen for several imprinted genes, while for other genes
such patterns await discovery.  The theory predicts relaxation of parental
conflict with age and so raises the hypothesis that change in parental bias is
linked to aging.  Studies on young adult mice partially support that
hypothesis but experimental evidence from humans, including older individuals,
is missing.
...
functions, whose importance has been increasing in human evolution.  Indeed,
most human imprinted gene syndromes are characterized by not only growth
disorder but also mental retardation and psychiatric dysfunction.  Therefore
paternally and maternally expressed genes appear to play antagonistic roles
not only in growth but also in psychiatric functions as overexpression of tend
to co-occur with autistic while the latter with psychotic spectrum disorders.
For example, maternally derived microduplications at 15q11-q13 may not only
cause the Prader-Willi syndrome whose symptoms include obesity and psychosis,
but also enhance the risk for schizophrenia, perhaps the most devastating
...
separately.  Recently the CommonMind Consortium established a genome-wide
resource on gene expression in dorsolateral prefrontal cortex (DLPFC) of
hundreds of schizophrenic and control individuals, and identified some 650
differentially expressed genes.  Here we extend that analysis with a special
focus on imprinted genes by quantifying parental bias and its variation across
genes and individuals.  We find that \(\approx 1\%\) of all genes are
parentally biased, in agreement with most but a few studies in mouse.  We
identify genes, such as UBE3A in 15q11-q13, whose bias varies with age and/or
psychiatric condition.  We also observe variation with respect to gender and
ancestry.
...
\begin{itemize}
\item kin selection: imprinting, imprinted brain, aging~\cite{Bourke2007}
...
\item mechanistic interpretation of association between SCZ and parental bias:
maternal genes promote psychotic spectrum conditions (imprinted brain); UBE3A,
RP11-909M7.3/MEG8: SCZ maternal microduplications at
15q11-q13~\cite{Ingason2011,Rees2014} 
\item expression in SCZ: total read count approach~\cite{Fromer2016a} vs
present read count ratio approach; discrepancy, challenges in modeling for joint analysis
...
\cite{Fromer2016a} to be differentially expressed in SCZ based on the same
RNA-seq data set but obtained with an approach
that ignores allele-specific read counts. PEG10, but not IGF2, is among the 4 genes the
