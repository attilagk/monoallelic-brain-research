...
\end{center}
\caption{ Using the read count ratio statistic \(S\) to report on variation of allelic
...
for heat map and green filled circles marking genes' score at \(1 - \mathrm{ECDF}(0.9)\); (3) the same
