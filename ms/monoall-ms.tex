...
are expected to influence the fit to the same degree.
}
...
\end{center}
\caption{
Fitting four fixed regression models on read count ratio data for the KCNK9
gene.  See the legend of Fig.~\ref{fig:fitting-fixed-PEG3} for details.
}
...
\end{center}
\caption{
Fitting various mixed regression models on read count ratio data for all genes
jointly. See the legend of Fig.~\ref{fig:fitting-fixed-PEG3} for details.
}
