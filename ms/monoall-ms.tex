...
selected (see Methods)}
\item \added{global models (condidering genes jointly) gave stronger results than
local ones}
\item \added{terms significantly improving model fit include technical ones;
including them in the model corrects for large technical noise}
\item \added{terms significantly improving model fit identify as 
biological regulators of parental bias Ancestry.1 and Age}
\item \added{both variables affect parental bias in a gene-specific manner}
\end{itemize}
