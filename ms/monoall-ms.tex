...
The number of imprinted genes in the brain has been controversial: early
genome wide studies~\cite{Gregg2010a} estimated over a thousand but later the
same authors and others~\cite{Perez2015,DeVeale2012,Baran2015} found that the
statistical estimator was heavily biased and with more careful statistical
analysis they discovered hundred or less imprinted genes in the brain.  Our
work reinforces the latter group of studies as we identified 30 imprinted
genes in the DLPFC among the genes we could assess (about the third of all
genes). 
