...
\%\))~\cite{Andergassen2017,Babak2015,Baran2015,DeVeale2012,Perez2015} as opposed to
...
cis-eQTL effects~\cite{Babak2015} (see Methods: Reference/non-reference allele test and Test
...
\(j\) and then scales the ranks between 1 and 100.
\end{enumerate}
