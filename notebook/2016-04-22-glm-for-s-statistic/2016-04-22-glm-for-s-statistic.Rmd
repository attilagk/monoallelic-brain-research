...
coplot(S_PEG3 ~ Age.of.Death | Institution, data=d, pch='.', cex=2)
coplot(S_PEG3 ~ Age.of.Death | DLPFC_RNA_isolation..RIN, data=d, pch='.', cex=2)
coplot(S_PEG3 ~ Age.of.Death | Ancestry.EV.2, data=d, pch='.', cex=2)
```
