...
```{r s-stat-simple-regr, cache=FALSE, echo=FALSE, fig.width=9, dev=c('png','pdf')}
...
```{r coplot-r-peg3, echo=FALSE, warning=FALSE, dev=c('png','pdf')}
# condition R_PEG3 vs age on a given institution, RIN value and ancestry
coplot(R_PEG3 ~ Age.of.Death | Institution, data=d, pch='.', cex=2)
coplot(R_PEG3 ~ Age.of.Death | DLPFC_RNA_isolation..RIN, data=d, pch='.', cex=2)
coplot(R_PEG3 ~ Age.of.Death | Ancestry.EV.2, data=d, pch='.', cex=2)
```
