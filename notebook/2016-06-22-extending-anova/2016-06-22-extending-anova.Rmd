...
Under `logi.S`:
```{r anova-fw-rv-logi.S, dev=c("png","pdf"), fig.width=12, echo=FALSE}
...
```{r anova-fw-rv-wnlm.R, dev=c("png","pdf"), fig.width=12, echo=FALSE}
par(mar = c(8, 3, 2, 1), mfrow = c(1, 1), mfrow = 1:2)
...
Under `logi.S`:
```{r effects-fw-rv-logi.S, dev=c("png","pdf"), fig.width=12, echo=FALSE}
par(mar = c(8, 3, 2, 1), mfrow = c(1, 1), mfrow = 1:2)
...
```{r effects-fw-rv-wnlm.R, dev=c("png","pdf"), fig.width=12, echo=FALSE}
par(mar = c(8, 3, 2, 1), mfrow = c(1, 1), mfrow = 1:2)
