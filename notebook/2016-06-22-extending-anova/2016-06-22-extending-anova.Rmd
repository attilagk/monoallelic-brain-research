...
```{r anova-effects-fw-rv-logi.S, echo=FALSE, fig.asp=1}
print(plots$anova.logi.S, split = c(1, 1, 1, 2), more = TRUE)
print(plots$effects.logi.S, split = c(1, 2, 1, 2), more = FALSE)
```
