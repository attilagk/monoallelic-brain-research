...
```{r segplot-logi.S-wnlm.R, fig.asp=1, echo=FALSE}
sp <- list()
...
plot(sp$logi.S, split = c(1, 1, 2, 1), more = TRUE)
plot(sp$wnlm.R, split = c(2, 1, 2, 1), more = FALSE)
```
...
```{r segplot-logi.S-wnlm.R.95, fig.asp=1, echo=FALSE}
sp.95 <- list()
...
plot(sp.95$logi.S, split = c(1, 1, 2, 1), more = TRUE)
plot(sp.95$wnlm.R, split = c(2, 1, 2, 1), more = FALSE)
```
