...
sp$unlm.R <- my.segplot(beta.age$unlm.R, main = "unlm.R", xlim = c(-0.7, 0.7))
...
plot(sp$unlm.R, split = c(2, 2, 2, 2), more = FALSE)
```
...
sp.95$unlm.R <- my.segplot(beta.age.95$unlm.R, main = "unlm.R", xlim = c(-0.7, 0.7))
...
plot(sp.95$unlm.R, split = c(2, 2, 2, 2), more = FALSE)
```
