...
update(b.charts$min.reads.15, main = "", auto.key = list(text = c("known imprinted", "nearby candidate", "distant candidate"), points = FALSE, col = c("blue", "darkgreen", "red"), columns = 1), scales = list(cex = 0.7))
```
...
```{r filtering-calling-venn-euler}
