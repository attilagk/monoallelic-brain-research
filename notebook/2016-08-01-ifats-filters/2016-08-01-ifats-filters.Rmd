...
update(b.charts$min.reads.15, main = "", auto.key = list(text = c("known imprinted", "unknown within 1 Mb", "unknown without 1 Mb"), points = FALSE, col = c("blue", "darkgreen", "red"), columns = 1), scales = list(cex = 0.7))
```
