...
levels(gene.summary$imprinting.status) <- c("known", "candidate, <1MB", "candidate")
...
update(b.charts$min.reads.15, main = "", auto.key = list(text = c("known imprinted", "candidate, <1MB", "candidate, >1MB"), points = FALSE, col = c("blue", "darkgreen", "red"), columns = 1))
```
