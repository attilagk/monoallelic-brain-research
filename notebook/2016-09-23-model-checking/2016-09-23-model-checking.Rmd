...
update(myhomoscedas("wnlm.S"), xlim = c(0.65, 1.05))
```

```{r homoscedas-unlm-R, echo=FALSE}
#update(myhomoscedas("unlm.R"), xlim = c(0, 100))
```
...
update(myhomoscedas("wnlm.R"), xlim = c(0, 100))
```

```{r homoscedas-logi-S, echo=FALSE, warning=FALSE}
update(myhomoscedas("logi.S", skip = skip), xlim = c(0.65, 1))
```

```{r homoscedas-logi2-S, echo=FALSE, warning=FALSE}
#update(myhomoscedas("logi2.S", skip = skip2), xlim = c(0.65, 1))
```
