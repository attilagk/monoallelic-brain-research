         ...
         dotplot(ordered(Level, levels = rev(levels(Level))) ~ Estimate | Gene,
                 ...
                 par.settings =
                     list(strip.background = list(col = "lightgray"), plot.symbol =
                          list(pch = 21), superpose.symbol = list(pch = 21)),
...
```{r beta-age-cond-logi.S, dev=c("png", "pdf"), fig.width=10, warning=FALSE, echo=FALSE, message=FALSE}
my.segplot(Betas$logi.S, main = expression(paste("Estimate and 99 % CI for ", beta[age] , " under logi.S")))
#my.segplot2(Betas$logi.S, main = expression(paste("Estimate and 99 % CI for ", beta[age] , " under logi.S")))
```

```{r beta-age-cond-wnlm.R, dev=c("png", "pdf"), fig.width=10, warning=FALSE, echo=FALSE, message=FALSE}
my.segplot(Betas$wnlm.R, main = expression(paste("Estimate and 99 % CI for ", beta[age] , " under wnlm.R")))
```
