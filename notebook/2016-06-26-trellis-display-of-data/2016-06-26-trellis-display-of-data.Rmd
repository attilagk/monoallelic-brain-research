...
```
```{r S-age-smooth, dev=c("png", "pdf"), fig.width=10, warning=FALSE}
P <- list()
...
```{r S-age-tot-read-count, dev=c("png", "pdf"), fig.width=10, warning=FALSE, echo=FALSE}
# easy lattice implementation
P$s.age.n$lattice <-
    levelplot(log10(N) ~ Age + S | Gene, data = Y.long, alpha = 1.0, col = "white",
              panel = panel.levelplot.points, layout = c(6, 6),
...
```{r rin-rin2, dev=c("png", "pdf"), fig.width=3, warning=FALSE, echo=FALSE, dpi=72}
...
```{r evar-scatterplot-matrix, dev=c("png", "pdf"), fig.width=10, fig.asp=1, warning=FALSE, echo=FALSE, message=FALSE}
P$splom$lattice <-
