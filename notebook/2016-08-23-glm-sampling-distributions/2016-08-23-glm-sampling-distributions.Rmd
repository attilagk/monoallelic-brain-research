...
```{r GRB10, echo=FALSE}
plots <- list()
(plots$GRB10 <- plot.predictions(gp$GRB10, main = "GRB10"))
```

```{r PEG3, echo=FALSE}
(plots$PEG3 <- plot.predictions(gp$PEG3, main = "PEG3"))
```

```{r ZNF331, echo=FALSE}
(plots$ZNF331 <- plot.predictions(gp$ZNF331, main = "ZNF331"))
```

```{r ZDBF2, echo=FALSE}
(plots$ZDBF2 <- plot.predictions(gp$ZDBF2, main = "ZDBF2"))
```

### Examples for up-regulation

```{r KCNK9, echo=FALSE}
(plots$KCNK9 <- plot.predictions(gp$KCNK9, main = "KCNK9"))
```

```{r PEG10, echo=FALSE}
(plots$PEG10 <- plot.predictions(gp$PEG10, main = "PEG10"))
```
...
(plots$PEG3 <- plot.predictions(gp$PEG3, main = "PEG3", show.model = FALSE))
```

```{r KCNK9-data-only, echo=FALSE}
(plots$KCNK9 <- plot.predictions(gp$KCNK9, main = "KCNK9", show.model = FALSE))
```
