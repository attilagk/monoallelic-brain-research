...
my.panel <- function(...) { panel.abline(a = 0, b = 1, lty = "dotted", col = "gray"); panel.xyplot(...) }
my.main <- "Fixed effects w/o variancePartition"
xyplot(unlm.Q.varPart ~ unlm.Q | gene, data = cf, panel = my.panel, main = my.main)
xyplot(unlm.Q.varPart ~ unlm.Q | coefficient, data = cf, panel = my.panel, scales = list(relation = "free"), main = my.main)
```
...
xyplot(mixed.1 ~ unlm.Q | gene, data = cf, panel = my.panel, main = my.main)
xyplot(mixed.1 ~ unlm.Q | coefficient, data = cf, panel = my.panel, scales = list(relation = "free"), main = my.main)
```
...
xyplot(mixed.1 ~ wnlm.Q | gene, data = cf, panel = my.panel, main = my.main)
xyplot(mixed.1 ~ wnlm.Q | coefficient, data = cf, panel = my.panel, scales = list(relation = "free"), main = my.main)
```
