...
\begin{frame}[t, plain]
\begin{center}
\includegraphics[height=1.0\textheight]{figures/2016-07-19-genome-wide-S/complex-plot-1.png}
\end{center}
\end{frame}
...
\includegraphics[height=0.7\textheight]{figures/2016-08-01-ifats-filters/top-ranking-genes-2.pdf}
\end{column}
...
\includegraphics[width=1.0\columnwidth]{figures/2016-07-19-genome-wide-S/complex-plot-1.png}
\end{column}

\begin{column}{0.6\textwidth}

\includegraphics[width=1.0\columnwidth]{figures/2016-06-26-trellis-display-of-data/S-age-gender-2}
\end{column}
\end{columns}
\end{frame}
...
\begin{center}
\includegraphics[width=0.8\textheight]{figures/2016-06-26-trellis-display-of-data/evar-scatterplot-matrix-1.png}
\end{center}
\end{frame}
...
\begin{column}{0.5\textwidth}
\only<2>{normality of residuals}
\only<3>{homogeneity of error}
\only<4>{influence of outliers}

\only<2->{\tiny{(multiple regression)}}
...
\includegraphics[width=0.9\textwidth]{figures/2017-02-14-beta-from-mixed-model/tval-varpart-fixed-present-1.png}
\end{frame}
...
\includegraphics[height=0.8\textheight]{figures/2016-06-22-extending-anova/unlm-Q-wnlm-Q-compare-1.pdf}
\end{frame}
...
\includegraphics[width=\columnwidth]{figures/2016-07-08-conditional-inference/beta-age-cond-wnlm-Q-2-present-1.pdf}
\end{frame}
