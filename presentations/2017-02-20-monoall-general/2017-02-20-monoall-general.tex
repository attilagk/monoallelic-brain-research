...
\includegraphics[width=1.0\columnwidth]{figures/2016-06-26-trellis-display-of-data/S-age-tot-read-count-1.png}
\end{column}
\end{columns}
\end{frame}
...
\begin{center}
\includegraphics[width=0.7\textwidth]{figures/2016-08-23-glm-sampling-distributions/ZNF331-1.png}
\end{center}
\end{frame}
