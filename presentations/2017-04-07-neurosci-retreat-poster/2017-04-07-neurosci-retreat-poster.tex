...
\begin{columns}
\column{0.5}
\block{The allelic bias of imprinted genes}{
\large
\begin{multicols}{2}
...
\end{center}
The figure shows, for any gene, a large inter-individual variation of
...
inter-individual distribution function ECDF and inferred genes with highest
score---among other criteria---to be imprinted.
}
...
(e.g.~KCNK9) with age or is independent of age (MEST).  However, the 
...
regression model
based on which we inferred which predictor(s) \(\{X_i\}\) the read count ratio
\(Y\) depends on significantly.
...
Age         &   1.80 &  0.653 \\
\hline
\textbf{Age.Gene}    & \textbf{-23.4}    &  \textbf{2.53-06} \\
\hline
Ances1      &  -0.246 &  0.134 \\
\textbf{Ances1.Gene} & \textbf{-56.800} &  \textbf{4.83e-13} \\
\hline
Gender.fix  &   1.020 &  0.32100 \\
Gender.ran  &   2.000 &  1.00000 \\
\textbf{Gender.Gene} &  \textbf{-5.800} &  \textbf{0.00524} \\
Dx.fix      &   3.890 &  0.94800 \\
Dx.ran      &   2.000 &  1.00000  \\
Dx.Gene     &   0.453 &  0.21400 \\
\hline
\end{tabular}
\end{center}
}
